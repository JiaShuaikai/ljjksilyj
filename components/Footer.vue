...
<template>
  ...
  >
    ...
    >
      <div>
        <span>Total PV : </span>
        <span text="pink">{{ umami.pv }}</span>
        <span class="mx-1">|</span>
        <span>UV : </span>
        <span text="pink">{{ umami.uv }}</span>
      </div>
      ...
      <div class="flex flex-col justify-center items-center lg:flex-row md:flex-row sm:flex-row xl:flex-row">
        <div class="m-2 flex flex-row">
          ...
          <span class="mx-1">:</span>
          <span text="pink mx-1">{{ umami.active }}</span>
        </div>
        <div>
          <span>From : </span>
          <span class="mx-1">{{ umami.recent.icon }}</span>
          <span text="pink">{{ umami.recent.name }}</span>
        </div>
      </div>
    </div>
    <div
    ...
    >
      <div class="flex flex-col items-start">
        <div>
          ...
          <span class="mx-1">|</span>
          <a href="https://beian.miit.gov.cn/" target="_blank">豫ICP备2024059788号</a>
        </div>
        <div class="mt-10">
