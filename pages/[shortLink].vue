...
useSeoMeta({
  title: () => {
    return article ? `${article.title} | 库洛米` : "404 NotFound | 库洛米";
  },
  ogTitle: () => {
    return article ? `${article.title} | 库洛米` : "404 NotFound | 库洛米";
  },
...
<template>
  ...
  <div v-else class="w-full text-center">
    <h1 class="text-10 pt-40vh">404 Not Found</h1>
    <NuxtLink to="/" class="text-violet mt-2 hover:underline-violet">Back To Home</NuxtLink>
  </div>
</template>
